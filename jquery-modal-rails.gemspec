...
Gem::Specification.new do |s|
  ...
  s.summary     = "The simplest possible modal for jQuery for the Rails asset pipeline"
  s.description = "The simplest possible modal for jQuery for the Rails asset pipeline based on https://github.com/kylefox/jquery-modal."
